...
centroids,labels=kmeans2(scorelist,5)
...
#fig = plt.figure()
#ax = fig.add_subplot(111, projection='3d')
#ax.scatter(fvector[:,0],fvector[:,1],ratinglist,c=colorvalues,s=50)
plt.scatter(scorelist,ratinglist,c=colorvalues,s=50)
#plt.scatter(length,score,c=colorvalues,s=100)
plt.show()

with open("cluster-rating.csv","wb") as f:
